...
namespace XoCrazy.UI
{
    ...
    public sealed class XoCrazyToolWindow : ToolWindowPane
    {
        private readonly XoCrazyControl _control;

        public XoCrazyToolWindow() : base(null)
        {
            Caption = "XoCrazy";
