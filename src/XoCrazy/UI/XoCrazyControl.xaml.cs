...
namespace XoCrazy.UI
{
    ...
    public partial class XoCrazyControl : UserControl
    {
        ...
        public void Initialize(IServiceProvider services)
        {
            ...
            _session = new XoCrazySession(services);
            if (!_session.IsReady)
            {
        ...
        /// <summary>
        /// The way out. Everything XoCrazy did goes back to the VS theme — the editor, the
