...
namespace XoCrazy.Core
{
    ...
    /// </summary>
    internal sealed class XoCrazySession : IDisposable
    {
        ...
        public XoCrazySession(IServiceProvider services)
        {
        ...
        /// <summary>
        /// Undoes XoCrazy entirely: every item it has ever touched goes back to whatever the
        ...
        /// with, which on the second session is still an XoCrazy-painted editor — the saved theme was
